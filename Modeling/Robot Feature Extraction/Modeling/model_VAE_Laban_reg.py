...
import utilities
from .model_VAE_NLoss import VAE_Encoder, VAE_Decoder
...
class LabanReg(nn.Module):
    def __init__(self, config):
        ...
        self.linear2 = torch.nn.Linear(config["hidden_dims"][0],config["hidden_dims"][1])
        self.relu2 = torch.nn.ReLU()

        self.linear3 = torch.nn.Linear(config["hidden_dims"][1],config["hidden_dims"][2])
