...
class ProcessTrajectory():
    ...
    def generate_plot(self, trajectory, x_label="Sample",
                        ...
                        title="Kinematic Twist Mobile Base"):
    ...
    def plot_trajectory(self, pendulum_trajectory, network_output, human_input):
        ...
        for j, (figr,ax) in enumerate(zip(figs,axs)):
            ...
            figr.suptitle('Kinematic Twist Mobile Base', fontsize=20)
    ...
    def start_generation(self, trajectory_path, key, save=False, cutoff_freq=0.8, fs=60):
        ...
        trajectory = self.interpolate_samples(trajectory_orign, sample_num=120)
        print(np.shape(trajectory))
